...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(
        ["exports", "@pixi/utils", "@pixi/math", "@pixi/core", "@pixi/display"],
        e
      )
    : e(
  ...
  const n = class {
    ...
    updateParameters(t, e) {
      ...
      switch (this._blinkingState) {
        case h.EyeState_Closing:
          (s =
            (this._userTimeSeconds - this._stateStartTimeSeconds) /
            this._closingSeconds),
            s >= 1 &&
              ((s = 1),
              (this._blinkingState = h.EyeState_Closed),
              (this._stateStartTimeSeconds = this._userTimeSeconds)),
            (i = 1 - s);
          break;
        case h.EyeState_Closed:
          (s =
            (this._userTimeSeconds - this._stateStartTimeSeconds) /
            this._closedSeconds),
            s >= 1 &&
              ((this._blinkingState = h.EyeState_Opening),
              (this._stateStartTimeSeconds = this._userTimeSeconds)),
            (i = 0);
          break;
        case h.EyeState_Opening:
          (s =
            (this._userTimeSeconds - this._stateStartTimeSeconds) /
            this._openingSeconds),
            s >= 1 &&
              ((s = 1),
              (this._blinkingState = h.EyeState_Interval),
              (this._nextBlinkingTime = this.determinNextBlinkingTiming())),
            (i = s);
          break;
        case h.EyeState_Interval:
          this._nextBlinkingTime < this._userTimeSeconds &&
            ((this._blinkingState = h.EyeState_Closing),
            (this._stateStartTimeSeconds = this._userTimeSeconds)),
            (i = 1);
          break;
        case h.EyeState_First:
        default:
          (this._blinkingState = h.EyeState_Interval),
            (this._nextBlinkingTime = this.determinNextBlinkingTiming()),
            (i = 1);
    ...
    constructor(t) {
      var e, i;
      (this._blinkingState = h.EyeState_First),
        ...
        null != t &&
          (this._parameterIds =
            null !=
            (i = null == (e = t.getEyeBlinkParameters()) ? void 0 : e.slice())
              ? i
              : this._parameterIds);
    }
    determinNextBlinkingTiming() {
      const t = Math.random();
      return (
        this._userTimeSeconds + t * (2 * this._blinkingIntervalSeconds - 1)
      );
    }
  };
  let l = n;
  ...
  const m = class {
    ...
    static quadraticEquation(t, e, i) {
      return this.abs(t) < m.Epsilon
        ? this.abs(e) < m.Epsilon
          ? -i
          : -i / e
        : -(e + this.sqrt(e * e - 4 * t * i)) / (2 * t);
    }
    static cardanoAlgorithmForBezier(t, e, i, s) {
      if (this.sqrt(t) < m.Epsilon)
      ...
      if (u < 0) {
        const t = -o / 3,
          ...
          n = Math.acos(a),
          h = 2 * this.cbrt(i),
          u = h * this.cos(n / 3) - r / 3;
        if (this.abs(u - d) < c) return this.range(u, 0, 1);
        const m = h * this.cos((n + 2 * Math.PI) / 3) - r / 3;
        if (this.abs(m - d) < c) return this.range(m, 0, 1);
        const g = h * this.cos((n + 4 * Math.PI) / 3) - r / 3;
      ...
      if (0 == u) {
        ...
        const e = 2 * t - r / 3;
        if (this.abs(e - d) < c) return this.range(e, 0, 1);
        const i = -t - r / 3;
        return this.range(i, 0, 1);
      }
      const g = this.sqrt(u),
        p = this.cbrt(g - h) - this.cbrt(g + h) - r / 3;
  ...
  class p {
    ...
    translateRelative(t, e) {
      ...
      p.multiply(i, this._tr, this._tr);
    }
    translate(t, e) {
    ...
    multiplyByMatrix(t) {
      p.multiply(t.getArray(), this._tr, this._tr);
    }
    clone() {
      const t = new p();
  ...
  class _ {
    ...
    constructor() {
      (this._isCulling = !1),
        ...
        (this._anisortopy = 0),
        (this._modelColor = new y()),
        (this._mvpMatrix4x4 = new p()),
  ...
  class C {
    static startUp(t) {
      if (v) return I("CubismFramework.startUp() is already done."), v;
      if (Live2DCubismCore._isStarted) return (v = !0), !0;
      if (
        ((Live2DCubismCore._isStarted = !0),
        (x = t),
        x && Live2DCubismCore.Logging.csmSetLogFunction(x.logFunction),
        (v = !0),
        v)
      ) {
      ...
      return I("CubismFramework.startUp() is complete."), v;
    }
    static cleanUp() {
      (v = !1), (M = !1), (x = void 0);
    }
    static initialize() {
      v
        ? M
          ...
          : ((M = !0), I("CubismFramework.initialize() is complete."))
    ...
    static dispose() {
      v
        ? M
          ? (_.staticRelease(),
            (M = !1),
            I("CubismFramework.dispose() is complete."))
    ...
    static getLoggingLevel() {
      return null != x ? x.loggingLevel : S.LogLevel_Off;
    }
    constructor() {}
  }
  var S = ((t) => (
  ...
  const b = () => {};
  function w(t, ...e) {
    E.print(S.LogLevel_Debug, "[CSM][D]" + t + "\n", e);
  }
  function I(t, ...e) {
    E.print(S.LogLevel_Info, "[CSM][I]" + t + "\n", e);
  }
  function L(t, ...e) {
    E.print(S.LogLevel_Warning, "[CSM][W]" + t + "\n", e);
  }
  function T(t, ...e) {
    E.print(S.LogLevel_Error, "[CSM][E]" + t + "\n", e);
  }
  class E {
    static print(t, e, i) {
      if (t < C.getLoggingLevel()) return;
      const s = C.coreLogFunction;
      if (!s) return;
  ...
  class D {
    ...
    getPartOpacityByIndex(t) {
      return t in this._notExistPartOpacities
        ...
        : (0 <= t && this.getPartCount(), this._partOpacities[t]);
    }
    ...
    getDrawableBlendMode(t) {
      ...
      return Live2DCubismCore.Utils.hasBlendAdditiveBit(e[t])
        ? f.CubismBlendMode_Additive
        : Live2DCubismCore.Utils.hasBlendMultiplicativeBit(e[t])
        ? f.CubismBlendMode_Multiplicative
        : f.CubismBlendMode_Normal;
    }
  ...
  class F {
    ...
    createModel() {
      ...
      if (e) return (t = new D(e)), ++this._modelCount, t;
      throw new Error("Unknown error");
    }
    deleteModel(t) {
    ...
    updateParameters(t, e, i) {
      ...
      (s =
        ...
        (0 == this._fadeOutSeconds || e.getEndTime() < 0
          ? 1
          : g.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds))),
        e.setState(i, s),
  ...
  class O extends R {
    ...
    static create(t) {
      ...
      for (let a = 0; a < r.length; ++a) {
        ...
        switch (t.Blend) {
          case "Multiply":
            o = U.ExpressionBlendType_Multiply;
            break;
          case "Overwrite":
            o = U.ExpressionBlendType_Overwrite;
            break;
          default:
            o = U.ExpressionBlendType_Add;
        }
  ...
  (t.CubismConfig = void 0),
    ((k = t.CubismConfig || (t.CubismConfig = {})).supportMoreMaskDivisions =
      !0),
    (k.setOpacityFromMotion = !1);
  var N = ((t) => (
  ...
  class H {
    ...
    getEvaluationOptionFlag(t) {
      return (
        Y.EvaluationOptionFlag_AreBeziersRistricted == t &&
        !!this._json.Meta.AreBeziersRestricted
      );
    }
    getMotionCurveCount() {
  ...
  function J(t, e) {
    const i = e,
      ...
      h = 3 * a - 3 * s,
      u = s - i,
      d = g.cardanoAlgorithmForBezier(n, l, h, u),
      c = q(t[0], t[1], d),
      m = q(t[1], t[2], d),
      p = q(t[2], t[3], d),
      _ = q(c, m, d),
      f = q(m, p, d);
    return q(_, f, d).value;
  }
  function Q(t, e) {
    return t[0].value;
  }
    ...
    for (let l = s.baseSegmentIndex; l < a; ++l)
      if (
        ((o =
          ...
          (t.segments[l].segmentType == V.CubismMotionSegmentType_Bezier
            ? 3
            : 1)),
        t.points[o].time > i)
      ) {
  ...
  class et extends R {
    ...
    doUpdateParameters(e, i, s, r) {
      ...
      const d =
          this._fadeInSeconds <= 0
            ? 1
            : g.getEasingSine(
                (i - r.getFadeInStartTime()) / this._fadeInSeconds
              ),
        c =
          this._fadeOutSeconds <= 0 || r.getEndTime() < 0
            ? 1
            : g.getEasingSine((r.getEndTime() - i) / this._fadeOutSeconds);
      let m,
        p,
        _,
        f = a;
      ...
      for (
        p = 0;
        p < this._motionData.curveCount &&
        y[p].type == N.CubismMotionCurveTarget_Model;
        ++p
      )
        (m = tt(this._motionData, p, f)),
          y[p].id == this._modelCurveIdEyeBlink
            ? (n = m)
            : y[p].id == this._modelCurveIdLipSync && (o = m);
      for (
        ;
        p < this._motionData.curveCount &&
        y[p].type == N.CubismMotionCurveTarget_Parameter;
        ++p
      ) {
        if (((_ = e.getParameterIndex(y[p].id)), -1 == _)) continue;
        const t = e.getParameterValueByIndex(_);
        if (((m = tt(this._motionData, p, f)), n != Number.MAX_VALUE))
          for (let e = 0; e < this._eyeBlinkParameterIds.length && e < l; ++e)
            if (this._eyeBlinkParameterIds[e] == y[p].id) {
              (m *= n), (u |= 1 << e);
              break;
            }
        if (o != Number.MAX_VALUE)
          for (let e = 0; e < this._lipSyncParameterIds.length && e < l; ++e)
            if (this._lipSyncParameterIds[e] == y[p].id) {
              (m += o), (h |= 1 << e);
              break;
            }
        let a;
        if (y[p].fadeInTime < 0 && y[p].fadeOutTime < 0) a = t + (m - t) * s;
        else {
          let e, s;
          (e =
            y[p].fadeInTime < 0
              ...
              ? 1
              : g.getEasingSine(
                  (i - r.getFadeInStartTime()) / y[p].fadeInTime
                )),
            (s =
              y[p].fadeOutTime < 0
                ? c
                : 0 == y[p].fadeOutTime || r.getEndTime() < 0
                ? 1
                : g.getEasingSine((r.getEndTime() - i) / y[p].fadeOutTime));
          a = t + (m - t) * (this._weight * e * s);
        }
        e.setParameterValueByIndex(_, a, 1);
      }
      ...
      for (
        ;
        p < this._motionData.curveCount &&
        y[p].type == N.CubismMotionCurveTarget_PartOpacity;
        ++p
      )
        if (
          ((m = tt(this._motionData, p, f)),
          t.CubismConfig.setOpacityFromMotion)
        )
          e.setPartOpacityById(y[p].id, m);
        else {
          if (((_ = e.getParameterIndex(y[p].id)), -1 == _)) continue;
          e.setParameterValueByIndex(_, m);
        }
    ...
    parse(t) {
      ...
      const i = e.getEvaluationOptionFlag(
          Y.EvaluationOptionFlag_AreBeziersRistricted
        ),
      ...
      for (let n = 0; n < this._motionData.curveCount; ++n) {
        ...
        switch (e.getMotionCurveTarget(n)) {
          case "Model":
            t.type = N.CubismMotionCurveTarget_Model;
            break;
          case "Parameter":
            t.type = N.CubismMotionCurveTarget_Parameter;
            break;
          case "PartOpacity":
            t.type = N.CubismMotionCurveTarget_PartOpacity;
            break;
          default:
            L(
        ...
        for (let l = 0; l < e.getMotionCurveSegmentCount(n); ) {
          0 == l
            ? ((this._motionData.segments[o].basePointIndex = a),
              (this._motionData.points[a] = new j(
                e.getMotionCurveSegment(n, l),
                e.getMotionCurveSegment(n, l + 1)
              )),
              (a += 1),
              (l += 2))
            : (this._motionData.segments[o].basePointIndex = a - 1);
          switch (e.getMotionCurveSegment(n, l)) {
            case V.CubismMotionSegmentType_Linear:
              (this._motionData.segments[o].segmentType =
                V.CubismMotionSegmentType_Linear),
                (this._motionData.segments[o].evaluate = $),
                (this._motionData.points[a] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
                (a += 1),
                (l += 3);
              break;
            case V.CubismMotionSegmentType_Bezier:
              (this._motionData.segments[o].segmentType =
                V.CubismMotionSegmentType_Bezier),
                (this._motionData.segments[o].evaluate = i ? Z : J),
                (this._motionData.points[a] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
                (this._motionData.points[a + 1] = new j(
                  e.getMotionCurveSegment(n, l + 3),
                  e.getMotionCurveSegment(n, l + 4)
                )),
                (this._motionData.points[a + 2] = new j(
                  e.getMotionCurveSegment(n, l + 5),
                  e.getMotionCurveSegment(n, l + 6)
                )),
                (a += 3),
                (l += 7);
              break;
            case V.CubismMotionSegmentType_Stepped:
              (this._motionData.segments[o].segmentType =
                V.CubismMotionSegmentType_Stepped),
                (this._motionData.segments[o].evaluate = Q),
                (this._motionData.points[a] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
                ...
                (l += 3);
              break;
            case V.CubismMotionSegmentType_InverseStepped:
              (this._motionData.segments[o].segmentType =
                V.CubismMotionSegmentType_InverseStepped),
                (this._motionData.segments[o].evaluate = K),
                (this._motionData.points[a] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
      ...
      for (let n = 0; n < e.getEventCount(); ++n)
        (this._motionData.events[n].fireTime = e.getEventTime(n)),
          (this._motionData.events[n].value = e.getEventValue(n));
      e.release();
    }
    getFiredEvent(t, e) {
  ...
  class st {
    ...
    startMotion(t, e, i) {
      ...
      for (let r = 0; r < this._motions.length; ++r)
        (s = this._motions[r]),
          null != s && s.setFadeOut(s._motion.getFadeOutTime());
      return (
        (s = new it()),
        (s._autoDelete = e),
        (s._motion = t),
    ...
    getCubismMotionQueueEntry(t) {
      return this._motions.find(
        (e) => null != e && e._motionQueueEntryHandle == t
      );
    }
    ...
    doUpdateMotion(t, e) {
      ...
      for (; s < this._motions.length; ) {
        ...
        r.setLastCheckEventSeconds(e),
          r.isFinished()
            ? (r.release(), this._motions.splice(s, 1))
            : (r.isTriggeredFadeOut() &&
                r.startFadeOut(r.getFadeOutSeconds(), e),
              s++);
      }
      return i;
    }
  ...
  class nt {
    constructor() {
      (this.initialPosition = new c(0, 0)),
        (this.position = new c(0, 0)),
        (this.lastPosition = new c(0, 0)),
        (this.lastGravity = new c(0, 0)),
        (this.force = new c(0, 0)),
  ...
  class ut {
    constructor() {
      (this.destination = {}), (this.translationScale = new c(0, 0));
    }
  }
  class dt {
    constructor() {
  ...
  class gt {
    ...
    evaluate(t, e) {
      ...
      const o = new c();
      let n, l, h, u, d, m, p, _;
      (d = t.getModel().parameters.values),
        (m = t.getModel().parameters.maximumValues),
        (p = t.getModel().parameters.minimumValues),
        (_ = t.getModel().parameters.defaultValues);
      for (let f = 0; f < this._physicsRig.subRigCount; ++f) {
        (i = { angle: 0 }),
          (o.x = 0),
          (o.y = 0),
          (n = this._physicsRig.settings[f]),
          (l = this._physicsRig.inputs.slice(n.baseInputIndex)),
          (h = this._physicsRig.outputs.slice(n.baseOutputIndex)),
          (u = this._physicsRig.particles.slice(n.baseParticleIndex));
        for (let e = 0; e < n.inputCount; ++e)
          (s = l[e].weight / 100),
            -1 == l[e].sourceParameterIndex &&
              (l[e].sourceParameterIndex = t.getParameterIndex(l[e].source.id)),
            l[e].getNormalizedParameterValue(
              o,
              i,
              d[l[e].sourceParameterIndex],
              p[l[e].sourceParameterIndex],
              m[l[e].sourceParameterIndex],
              _[l[e].sourceParameterIndex],
              n.normalizationPosition,
              n.normalizationAngle,
              l[e].reflect,
              s
            );
        (r = g.degreesToRadian(-i.angle)),
          (o.x = o.x * g.cos(r) - o.y * g.sin(r)),
          (o.y = o.x * g.sin(r) + o.y * g.cos(r)),
          wt(
            u,
            n.particleCount,
            o,
            i.angle,
            this._options.wind,
            0.001 * n.normalizationPosition.maximum,
            e,
            5
          );
        for (let e = 0; e < n.outputCount; ++e) {
          ...
          -1 == h[e].destinationParameterIndex &&
            (h[e].destinationParameterIndex = t.getParameterIndex(
              h[e].destination.id
            ));
          const s = new c();
          (s.x = u[i].position.x - u[i - 1].position.x),
            (s.y = u[i].position.y - u[i - 1].position.y),
            (a = h[e].getValue(s, u, i, h[e].reflect, this._options.gravity));
          const r = h[e].destinationParameterIndex,
            o =
              !Float32Array.prototype.slice &&
              "subarray" in Float32Array.prototype
                ? JSON.parse(JSON.stringify(d.subarray(r)))
                : d.slice(r);
          It(o, p[r], m[r], a, h[e]);
          for (let t = r, e = 0; t < d.length; t++, e++) d[t] = o[e];
        }
      }
    }
    setOptions(t) {
    ...
    parse(t) {
      ...
      for (let a = 0; a < this._physicsRig.subRigCount; ++a) {
        const t = new lt();
        (t.normalizationPosition.minimum =
          e.getNormalizationPositionMinimumValue(a)),
          (t.normalizationPosition.maximum =
            e.getNormalizationPositionMaximumValue(a)),
          (t.normalizationPosition.defalut =
            e.getNormalizationPositionDefaultValue(a)),
          (t.normalizationAngle.minimum =
            e.getNormalizationAngleMinimumValue(a)),
          (t.normalizationAngle.maximum =
            e.getNormalizationAngleMaximumValue(a)),
          (t.normalizationAngle.defalut =
            e.getNormalizationAngleDefaultValue(a)),
        ...
        for (let i = 0; i < t.inputCount; ++i) {
          ...
          switch (
            ...
            case "X":
              (t.type = ot.CubismPhysicsSource_X),
                (t.getNormalizedParameterValue = _t);
              break;
            case "Y":
              (t.type = ot.CubismPhysicsSource_Y),
                (t.getNormalizedParameterValue = ft);
              break;
            case mt:
              (t.type = ot.CubismPhysicsSource_Angle),
                (t.getNormalizedParameterValue = yt);
          }
          (t.source.targetType = at.CubismPhysicsTargetType_Parameter),
        ...
        for (let i = 0; i < t.outputCount; ++i) {
          ...
          switch (
            ...
            (t.destination.targetType = at.CubismPhysicsTargetType_Parameter),
    ...
    initialize() {
      ...
      for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
        (e = this._physicsRig.settings[s]),
          ...
          (t[0].initialPosition = new c(0, 0)),
          (t[0].lastPosition = new c(
            t[0].initialPosition.x,
            t[0].initialPosition.y
          )),
          (t[0].lastGravity = new c(0, -1)),
          (t[0].lastGravity.y *= -1),
          (t[0].velocity = new c(0, 0)),
          (t[0].force = new c(0, 0));
        for (let s = 1; s < e.particleCount; ++s)
          (i = new c(0, 0)),
            (i.y = t[s].radius),
            (t[s].initialPosition = new c(
              t[s - 1].initialPosition.x + i.x,
              t[s - 1].initialPosition.y + i.y
            )),
            (t[s].position = new c(
              t[s].initialPosition.x,
              t[s].initialPosition.y
            )),
            (t[s].lastPosition = new c(
              t[s].initialPosition.x,
              t[s].initialPosition.y
            )),
            (t[s].lastGravity = new c(0, -1)),
            (t[s].lastGravity.y *= -1),
            (t[s].velocity = new c(0, 0)),
            (t[s].force = new c(0, 0));
      }
    }
  }
  ...
  function _t(t, e, i, s, r, a, o, n, l, h) {
    t.x += Lt(i, s, r, a, o.minimum, o.maximum, o.defalut, l) * h;
  }
  function ft(t, e, i, s, r, a, o, n, l, h) {
    t.y += Lt(i, s, r, a, o.minimum, o.maximum, o.defalut, l) * h;
  }
  function yt(t, e, i, s, r, a, o, n, l, h) {
    e.angle += Lt(i, s, r, a, n.minimum, n.maximum, n.defalut, l) * h;
  }
  function xt(t, e, i, s, r) {
    let a = t.x;
    return s && (a *= -1), a;
  }
  function vt(t, e, i, s, r) {
    let a = t.y;
    return s && (a *= -1), a;
  }
    ...
    return (
      (r =
        i >= 2
          ...
          : r.multiplyByScaler(-1)),
      (a = g.directionToRadian(r, t)),
      s && (a *= -1),
      a
    );
  }
  ...
  function wt(t, e, i, s, r, a, o, n) {
    let l,
      ...
      _ = new c(0, 0),
      f = new c(0, 0);
    (t[0].position = new c(i.x, i.y)),
      (l = g.degreesToRadian(s)),
      (d = g.radianToDirection(l)),
      d.normalize();
    for (let y = 1; y < e; ++y)
      (t[y].force = d.multiplyByScaler(t[y].acceleration).add(r)),
        (t[y].lastPosition = new c(t[y].position.x, t[y].position.y)),
        (h = t[y].delay * o * 30),
        (m = t[y].position.substract(t[y - 1].position)),
        (u = g.directionToRadian(t[y].lastGravity, d) / n),
        (m.x = g.cos(u) * m.x - m.y * g.sin(u)),
        (m.y = g.sin(u) * m.x + m.y * g.cos(u)),
        (t[y].position = t[y - 1].position.add(m)),
        (p = t[y].velocity.multiplyByScaler(h)),
        (_ = t[y].force.multiplyByScaler(h).multiplyByScaler(h)),
        (t[y].position = t[y].position.add(p).add(_)),
        (f = t[y].position.substract(t[y - 1].position)),
        f.normalize(),
        (t[y].position = t[y - 1].position.add(
          f.multiplyByScaler(t[y].radius)
        )),
        g.abs(t[y].position.x) < a && (t[y].position.x = 0),
        0 != h &&
  ...
  function It(t, e, i, s, r) {
    ...
    (a = r.getScale(r.translationScale, r.angleScale)),
      ...
      o < e
        ...
        : o > i &&
          (o > r.valueExceededMaximum && (r.valueExceededMaximum = o), (o = i)),
      (n = r.weight / 100),
      n >= 1 || (o = t[0] * (1 - n) + o * n),
      (t[0] = o);
  }
  function Lt(t, e, i, s, r, a, o, n) {
    let l = 0;
    const h = g.max(i, e);
    h < t && (t = h);
    const u = g.min(i, e);
  ...
  class At {
    ...
    getMaskRenderTexture() {
      ...
      if (
        ...
        (this._colorBuffer = this.gl.createTexture()),
          ...
          this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Ft),
          (this._maskTexture = new Bt(this._currentFrameNo, t));
      }
      return t;
    }
    setGL(t) {
    ...
    calcClippedDrawTotalBounds(t, e) {
      ...
      for (let n = 0; n < o; n++) {
        ...
        let u = Number.MAX_VALUE,
          ...
          c = Number.MIN_VALUE,
          m = Number.MIN_VALUE;
        const g = l * P.vertexStep;
        for (let t = P.vertexOffset; t < g; t += P.vertexStep) {
          const e = h[t],
            i = h[t + 1];
          e < u && (u = e),
            e > c && (c = e),
    ...
    release() {
      ...
      for (let r = 0; r < this._clippingContextListForMask.length; r++)
        this._clippingContextListForMask[r] &&
          (null == (t = this._clippingContextListForMask[r]) || t.release());
      (s._clippingContextListForMask = void 0),
        (s._clippingContextListForDraw = void 0),
        this._maskTexture &&
          (null == (e = this.gl) ||
            e.deleteFramebuffer(this._maskTexture.texture),
          (s._maskTexture = void 0)),
    ...
    initialize(t, e, i, s) {
      for (let r = 0; r < e; r++) {
        ...
        null == t &&
          ((t = new Rt(this, i[r], s[r])),
          this._clippingContextListForMask.push(t)),
    ...
    setupClippingContext(t, e) {
      ...
      if (i > 0) {
        ...
        this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Ft),
          ...
          this.gl.viewport(Dt[0], Dt[1], Dt[2], Dt[3]);
      }
    }
    findSameClip(t, e) {
      for (let i = 0; i < this._clippingContextListForMask.length; i++) {
    ...
    setupLayoutBounds(e) {
      ...
      for (let a = 0; a < 4; a++) {
        ...
        if (0 == e);
          ...
          const t = this._clippingContextListForMask[r++];
          (t._layoutChannelNo = a),
            (t._layoutBounds.x = 0),
            (t._layoutBounds.y = 0),
          ...
          for (let t = 0; t < e; t++) {
            let e = t % 2;
            e = ~~e;
            const i = this._clippingContextListForMask[r++];
            (i._layoutChannelNo = a),
        ...
        else if (t.CubismConfig.supportMoreMaskDivisions && e <= 16)
          for (let t = 0; t < e; t++) {
            let e = t % 4,
              i = t / 4;
            (e = ~~e), (i = ~~i);
        ...
        else T("not supported mask count : {0}", e);
      }
    }
    getColorBuffer() {
  ...
  class Rt {
    constructor(t, e, i) {
      (this._isUsing = !1),
        ...
        (this._allClippedDrawRect = new Tt()),
        (this._layoutBounds = new Tt()),
        (this._clippedDrawableIndexList = []),
        (this._matrixForMask = new p()),
  ...
  class Ot {
    static getInstance() {
      return null == Et ? ((Et = new Ot()), Et) : Et;
    }
    static deleteInstance() {
      Et && (Et.release(), (Et = void 0));
    }
    constructor() {
      this._shaderSets = [];
    }
    ...
    setupShaderProgram(t, e, i, s, r, a, o, n, l, h, u, d, c) {
      let m, g, p, _;
      u || T("NoPremultipliedAlpha is not allowed"),
        0 == this._shaderSets.length && this.generateShaders();
      const y = t.getClippingContextBufferForMask();
      if (null != y) {
        const t = this._shaderSets[kt.ShaderNames_SetupMask];
        ...
        const i = y._layoutChannelNo,
          r = y.getClippingManager().getChannelFlagAsColor(i);
        this.gl.uniform4f(t.uniformChannelFlagLocation, r.R, r.G, r.B, r.A),
          this.gl.uniformMatrix4fv(
            t.uniformClipMatrixLocation,
            !1,
            y._matrixForMask.getArray()
          );
        const n = y._layoutBounds;
        this.gl.uniform4f(
        ...
        let n;
        switch (l) {
          case f.CubismBlendMode_Normal:
          default:
            (n = this._shaderSets[kt.ShaderNames_NormalPremultipliedAlpha + r]),
              (m = this.gl.ONE),
              (g = this.gl.ONE_MINUS_SRC_ALPHA),
              (p = this.gl.ONE),
              (_ = this.gl.ONE_MINUS_SRC_ALPHA);
            break;
          case f.CubismBlendMode_Additive:
            (n = this._shaderSets[kt.ShaderNames_AddPremultipliedAlpha + r]),
              (m = this.gl.ONE),
              (g = this.gl.ONE),
              (p = this.gl.ZERO),
              (_ = this.gl.ONE);
            break;
          case f.CubismBlendMode_Multiplicative:
            (n = this._shaderSets[kt.ShaderNames_MultPremultipliedAlpha + r]),
              (m = this.gl.DST_COLOR),
              (g = this.gl.ONE_MINUS_SRC_ALPHA),
              (p = this.gl.ZERO),
              (_ = this.gl.ONE);
        ...
        this.gl.activeTexture(this.gl.TEXTURE0),
          ...
          this.gl.uniformMatrix4fv(n.uniformMatrixLocation, !1, d.getArray()),
      ...
      null == o.index && (o.index = this.gl.createBuffer()),
        ...
        this.gl.blendFuncSeparate(m, g, p, _);
    }
    ...
    generateShaders() {
      ...
      (this._shaderSets[0].shaderProgram = this.loadShaderProgram(Ut, Nt)),
        (this._shaderSets[1].shaderProgram = this.loadShaderProgram(Vt, Gt)),
        (this._shaderSets[2].shaderProgram = this.loadShaderProgram(jt, Xt)),
        (this._shaderSets[3].shaderProgram = this.loadShaderProgram(jt, zt)),
        ...
        (this._shaderSets[0].attributePositionLocation =
        ...
        (this._shaderSets[0].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[0].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[0].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[0].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[0].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[0].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[0].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[0].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[1].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[1].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[1].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[1].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[1].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[1].shaderProgram,
            "s_texture0"
          )),
        ...
        (this._shaderSets[1].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[1].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[2].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[2].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[2].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[2].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[2].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[2].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[2].samplerTexture1Location =
          this.gl.getUniformLocation(
            this._shaderSets[2].shaderProgram,
            "s_texture1"
          )),
        ...
        (this._shaderSets[2].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[2].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[2].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[2].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[2].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[2].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[3].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[3].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[3].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[3].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[3].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[3].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[3].samplerTexture1Location =
          this.gl.getUniformLocation(
            this._shaderSets[3].shaderProgram,
            "s_texture1"
          )),
        ...
        (this._shaderSets[3].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[3].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[3].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[3].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[3].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[3].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[4].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[4].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[4].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[4].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[4].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[4].shaderProgram,
            "s_texture0"
          )),
        ...
        (this._shaderSets[4].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[4].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[5].attributePositionLocation =
          this.gl.getAttribLocation(
        ...
        (this._shaderSets[5].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[5].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[5].samplerTexture1Location =
          this.gl.getUniformLocation(
            this._shaderSets[5].shaderProgram,
            "s_texture1"
          )),
        ...
        (this._shaderSets[5].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[5].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[5].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[5].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[5].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[5].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[6].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[6].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[6].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[6].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[6].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[6].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[6].samplerTexture1Location =
          this.gl.getUniformLocation(
            this._shaderSets[6].shaderProgram,
            "s_texture1"
          )),
        ...
        (this._shaderSets[6].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[6].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[6].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[6].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[6].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[6].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[7].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[7].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[7].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[7].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[7].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[7].shaderProgram,
            "s_texture0"
          )),
        ...
        (this._shaderSets[7].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[7].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[8].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[8].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[8].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[8].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[8].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[8].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[8].samplerTexture1Location =
          this.gl.getUniformLocation(
            this._shaderSets[8].shaderProgram,
            "s_texture1"
          )),
        ...
        (this._shaderSets[8].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[8].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[8].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[8].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[8].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[8].shaderProgram,
            "u_baseColor"
          )),
        (this._shaderSets[9].attributePositionLocation =
          this.gl.getAttribLocation(
            this._shaderSets[9].shaderProgram,
            "a_position"
          )),
        (this._shaderSets[9].attributeTexCoordLocation =
          this.gl.getAttribLocation(
            this._shaderSets[9].shaderProgram,
            "a_texCoord"
          )),
        (this._shaderSets[9].samplerTexture0Location =
          this.gl.getUniformLocation(
            this._shaderSets[9].shaderProgram,
            "s_texture0"
          )),
        (this._shaderSets[9].samplerTexture1Location =
          this.gl.getUniformLocation(
            this._shaderSets[9].shaderProgram,
            "s_texture1"
          )),
        ...
        (this._shaderSets[9].uniformClipMatrixLocation =
          this.gl.getUniformLocation(
            this._shaderSets[9].shaderProgram,
            "u_clipMatrix"
          )),
        (this._shaderSets[9].uniformChannelFlagLocation =
          this.gl.getUniformLocation(
            this._shaderSets[9].shaderProgram,
            "u_channelFlag"
          )),
        (this._shaderSets[9].uniformBaseColorLocation =
          this.gl.getUniformLocation(
            this._shaderSets[9].shaderProgram,
            "u_baseColor"
          ));
    ...
    loadShaderProgram(t, e) {
      ...
      if (!s) return T("Vertex shader compile error!"), 0;
      let r = this.compileShaderSource(this.gl.FRAGMENT_SHADER, e);
      if (!r) return T("Vertex shader compile error!"), 0;
    ...
    compileShaderSource(t, e) {
      ...
      if ((this.gl.shaderSource(s, i), this.gl.compileShader(s), !s)) {
        T("Shader compile log: {0} ", this.gl.getShaderInfoLog(s));
      }
  ...
  class Wt extends _ {
    ...
    drawMesh(t, e, i, s, r, a, o, n, l) {
      ...
      null == this.getClippingContextBufferForMask() &&
        ...
        this.isPremultipliedAlpha() &&
          ((h.R *= h.A), (h.G *= h.A), (h.B *= h.A)));
      let u = null;
      null != this._textures[t] && (u = this._textures[t]),
        Ot.getInstance().setupShaderProgram(
          this,
          u,
          i,
          r,
    ...
    startUp(t) {
      (this.gl = t), this._clippingManager.setGL(t), Ot.getInstance().setGl(t);
    }
  }
  _.staticRelease = () => {
    Wt.doStaticRelease();
    ...
    getLipSyncParameters() {
      ...
      return null ==
        (e =
          null == (t = this.groups)
            ? void 0
            : t.find((t) => "LipSync" === t.Name))
        ? void 0
        : e.Ids;
    }
  }
  const Yt = "ParamAngleX",
    qt = "ParamAngleY",
    $t = "ParamAngleZ",
    Zt = "ParamEyeBallX",
    Jt = "ParamEyeBallY",
  ...
  var te;
  (t.config = void 0),
    ((te = t.config || (t.config = {})).LOG_LEVEL_VERBOSE = 0),
    (te.LOG_LEVEL_WARNING = 1),
    (te.LOG_LEVEL_ERROR = 2),
    (te.LOG_LEVEL_NONE = 999),
    (te.logLevel = te.LOG_LEVEL_WARNING),
    (te.sound = !0),
    (te.motionSync = !0),
    (te.motionFadingDuration = 500),
    (te.idleMotionFadingDuration = 2e3),
    (te.expressionFadingDuration = 500),
    (te.preserveExpressionOnMotion = !0),
    (te.cubism4 = t.CubismConfig);
  const ee = {
    log(e, ...i) {
      t.config.logLevel <= t.config.LOG_LEVEL_VERBOSE &&
        console.log(`[${e}]`, ...i);
    },
    warn(e, ...i) {
      t.config.logLevel <= t.config.LOG_LEVEL_WARNING &&
        console.warn(`[${e}]`, ...i);
    },
    error(e, ...i) {
      t.config.logLevel <= t.config.LOG_LEVEL_ERROR &&
        console.error(`[${e}]`, ...i);
    },
  };
  function ie(t, e, i) {
  ...
  class oe extends e.EventEmitter {
    constructor(t, e) {
      super(),
        (this.expressions = []),
    ...
    loadExpression(t) {
      return __async(this, null, function* () {
        if (!this.definitions[t])
          return void ee.warn(this.tag, `Undefined expression at [${t}]`);
  ...
  class ne {
    ...
    focus(t, e, i = !1) {
      (this.targetX = ie(t, -1, 1)),
        (this.targetY = ie(e, -1, 1)),
    ...
    update(t) {
      ...
      const h = Math.sqrt(__pow(this.vx, 2) + __pow(this.vy, 2)),
        u = 0.5 * (Math.sqrt(__pow(l, 2) + 8 * l * s) - l);
  ...
  class le {
    constructor(t) {
      ...
      (this.url = e), (this.name = re(this.url));
    }
    resolveURL(t) {
  ...
  class ue {
    ...
    reserve(t, e, i) {
      if (i <= 0)
        return (
          ee.log(this.tag, "Cannot start a motion with MotionPriority.NONE."),
          !1
        );
      if (t === this.currentGroup && e === this.currentIndex)
        return (
          ee.log(this.tag, "Motion is already playing.", this.dump(t, e)), !1
        );
      if (
        ...
        return (
          ee.log(this.tag, "Motion is already reserved.", this.dump(t, e)), !1
        );
      if (1 === i) {
    ...
    static add(t, e, i) {
      ...
      return (
        ...
        s.addEventListener("error", (e) => {
          this.dispose(s),
            ee.warn("SoundManager", `Error occurred on "${t}"`, e.error),
            null == i || i(e.error);
        }),
        this.audios.push(s),
        s
      ...
      return new Promise((e, i) => {
        ...
        null == (s = t.play()) ||
          ...
          t.readyState === t.HAVE_ENOUGH_DATA
            ? e()
            : t.addEventListener("canplaythrough", e);
      });
    }
    static dispose(t) {
      t.pause(), t.removeAttribute("src"), ae(this.audios, t);
    }
    static destroy() {
  ...
  (de.audios = []), (de._volume = 0.5);
  var ce = ((t) => ((t.ALL = "ALL"), (t.IDLE = "IDLE"), (t.NONE = "NONE"), t))(
    ce || {}
  );
  class me extends e.EventEmitter {
    constructor(t, e) {
      super(),
        (this.motionGroups = {}),
        (this.state = new ue()),
    ...
    init(t) {
      (null == t ? void 0 : t.idleMotionGroup) &&
        (this.groups.idle = t.idleMotionGroup),
        this.setupMotions(t),
        this.stopAllMotions();
    }
    setupMotions(t) {
    ...
    loadMotion(t, e) {
      return __async(this, null, function* () {
        ...
        if (!(null == (i = this.definitions[t]) ? void 0 : i[e]))
          return void ee.warn(this.tag, `Undefined motion at "${t}"[${e}]`);
    ...
    startMotion(e, i) {
      return __async(this, arguments, function* (e, i, s = he.NORMAL) {
        var r;
        ...
        let o;
        if (
          (this.currentAudio && de.dispose(this.currentAudio), t.config.sound)
        ) {
          ...
          if (t)
            try {
              ...
              ee.warn(this.tag, "Failed to create audio", t, l);
            }
        }
        ...
        if (o) {
          const e = de
            .play(o)
            .catch((t) => ee.warn(this.tag, "Failed to play audio", o.src, t));
          t.config.motionSync && (yield e);
        }
        return this.state.start(n, e, i, s)
          ? (ee.log(this.tag, "Start motion:", this.getMotionName(a)),
            ...
            this._startMotion(n),
            !0)
          : (o && (de.dispose(o), (this.currentAudio = void 0)), !1);
      });
    }
    ...
    stopAllMotions() {
      this._stopAllMotions(),
        this.state.reset(),
        this.currentAudio &&
          (de.dispose(this.currentAudio), (this.currentAudio = void 0));
    }
    update(t, e) {
      var i;
      return (
        this.isFinished() &&
          ...
          this.state.shouldRequestIdleMotion() &&
            this.startRandomMotion(this.groups.idle, he.IDLE)),
  ...
  const ge = { x: 0, y: 0, width: 0, height: 0 };
  class pe extends e.EventEmitter {
    constructor() {
      super(...arguments),
        (this.focusController = new ne()),
  ...
  const fe = class {
    static createXHR(t, e, i, s, r) {
      ...
      if ((fe.allXhrSet.add(a), t)) {
        let e = fe.xhrMap.get(t);
        e ? e.add(a) : ((e = new Set([a])), fe.xhrMap.set(t, e)),
          t.listeners("destroy").includes(fe.cancelXHRs) ||
            t.once("destroy", fe.cancelXHRs);
      }
      return (
        a.open("GET", e),
        (a.responseType = i),
        ...
        (a.onerror = () => {
          ee.warn(
            "XHRLoader",
            `Failed to load resource as ${a.responseType} (Status ${a.status}): ${e}`
          ),
            r(new _e("Network error.", e, a.status));
        }),
        (a.onabort = () => r(new _e("Aborted.", e, a.status, !0))),
        (a.onloadend = () => {
          var e;
          fe.allXhrSet.delete(a),
            t && (null == (e = fe.xhrMap.get(t)) || e.delete(a));
        }),
        a
      );
    }
    static cancelXHRs() {
      var t;
      null == (t = fe.xhrMap.get(this)) ||
        t.forEach((t) => {
          t.abort(), fe.allXhrSet.delete(t);
        }),
        fe.xhrMap.delete(this);
    }
    static release() {
      fe.allXhrSet.forEach((t) => t.abort()),
        fe.allXhrSet.clear(),
        (fe.xhrMap = new WeakMap());
    }
  };
  let ye = fe;
  function xe(t, e) {
  ...
  (ye.xhrMap = new WeakMap()),
    (ye.allXhrSet = new Set()),
    (ye.loader = (t, e) =>
      new Promise((e, i) => {
        fe.createXHR(
          t.target,
  ...
  class ve {
    static load(t) {
      return xe(this.middlewares, t).then(() => t.result);
    }
  }
  ve.middlewares = [ye.loader];
  const Me = "Live2DFactory",
    Pe = (t, e) =>
      __async(this, null, function* () {
        if ("string" == typeof t.source) {
          const e = yield ve.load({
            url: t.source,
            type: "json",
    ...
    Ce = (t, e) =>
      __async(this, null, function* () {
        if (t.source instanceof le) return (t.settings = t.source), e();
        if ("object" == typeof t.source) {
          const i = Te.findRuntime(t.source);
          if (i) {
            const s = i.createModelSettings(t.source);
            return (
              (t.settings = s), t.live2dModel.emit("settingsLoaded", s), e()
            );
          }
        }
    ...
    Se = (t, e) => {
      if (t.settings) {
        const i = Te.findRuntime(t.settings);
                ...
                ve
                  ...
                  .catch((e) => {
                    t.live2dModel.emit("poseLoadError", e),
                      ee.warn(Me, "Failed to load pose.", e);
                  })
              ),
              e.physics &&
                r.push(
                  ve
                    ...
                    .catch((e) => {
                      t.live2dModel.emit("physicsLoadError", e),
                        ee.warn(Me, "Failed to load physics.", e);
                    })
                ),
    ...
    Ie = (t, e) =>
      __async(this, null, function* () {
        ...
        if (i instanceof le) {
          ...
          return (
            (t.internalModel = s.createInternalModel(a, i, t.options)), e()
          );
        }
    ...
    Le = class {
      static registerRuntime(t) {
        Le.runtimes.push(t), Le.runtimes.sort((t, e) => e.version - t.version);
      }
      static findRuntime(t) {
        for (const e of Le.runtimes) if (e.test(t)) return e;
      }
      static setupLive2DModel(t, e, i) {
        return __async(this, null, function* () {
          ...
          yield xe(Le.live2DModelMiddlewares, {
            live2dModel: t,
            source: e,
            options: i || {},
          }),
      ...
      static loadMotion(t, e, i) {
        ...
        try {
          ...
          t.listeners("destroy").includes(Le.releaseTasks) ||
            t.once("destroy", Le.releaseTasks);
          let o = Le.motionTasksMap.get(t);
          o || ((o = {}), Le.motionTasksMap.set(t, o));
          let n = o[e];
          n || ((n = []), (o[e] = n));
          const l = t.getMotionFile(a);
          return (
            null != n[i] ||
              (n[i] = ve
                .load({
                ...
                .then((s) => {
                  var r;
                  const o =
                    null == (r = Le.motionTasksMap.get(t)) ? void 0 : r[e];
                  o && delete o[i];
                  const n = t.createMotion(s, e, a);
                  return t.emit("motionLoaded", e, i, n), n;
                })
                .catch((e) => {
                  ee.warn(t.tag, `Failed to load motion: ${l}\n`, e), r(e);
                })),
            n[i]
          );
        } catch (a) {
          ee.warn(t.tag, `Failed to load motion at "${e}"[${i}]\n`, a), r(a);
        }
      ...
      static loadExpression(t, e) {
        ...
        try {
          ...
          t.listeners("destroy").includes(Le.releaseTasks) ||
            t.once("destroy", Le.releaseTasks);
          let r = Le.expressionTasksMap.get(t);
          r || ((r = []), Le.expressionTasksMap.set(t, r));
          const a = t.getExpressionFile(s);
          return (
            null != r[e] ||
              (r[e] = ve
                .load({ url: a, settings: t.settings, type: "json", target: t })
                .then((i) => {
                  const r = Le.expressionTasksMap.get(t);
                  r && delete r[e];
                  const a = t.createExpression(i, s);
                  return t.emit("expressionLoaded", e, a), a;
                })
                .catch((e) => {
                  ee.warn(t.tag, `Failed to load expression: ${a}\n`, e), i(e);
                })),
            r[e]
          );
        } catch (s) {
          ee.warn(t.tag, `Failed to load expression at [${e}]\n`, s), i(s);
        }
        return Promise.resolve(void 0);
      }
      static releaseTasks() {
        this instanceof me
          ? Le.motionTasksMap.delete(this)
          : Le.expressionTasksMap.delete(this);
      }
    };
  let Te = Le;
  (Te.runtimes = []),
    (Te.urlToJSON = Pe),
    (Te.jsonToSettings = Ce),
    (Te.waitUntilReady = Se),
    (Te.setupOptionals = be),
    (Te.setupEssentials = we),
    (Te.createInternalModel = Ie),
    (Te.live2DModelMiddlewares = [Pe, Ce, Se, be, we, Ie]),
    (Te.motionTasksMap = new WeakMap()),
    (Te.expressionTasksMap = new WeakMap()),
    (me.prototype._loadMotion = function (t, e) {
      return Te.loadMotion(this, t, e);
    }),
    (oe.prototype._loadExpression = function (t) {
      return Te.loadExpression(this, t);
    });
  class Ee {
    constructor() {
    ...
    set autoInteract(t) {
      t !== this._autoInteract &&
        (t ? this.on("pointertap", De, this) : this.off("pointertap", De, this),
        (this._autoInteract = t));
    }
    registerInteraction(t) {
      t !== this.interactionManager &&
        ...
        this._autoInteract &&
          t &&
          ((this.interactionManager = t), t.on("pointermove", Fe, this)));
    }
    unregisterInteraction() {
      var t;
      this.interactionManager &&
        (null == (t = this.interactionManager) ||
          t.off("pointermove", Fe, this),
  ...
  class Ae extends i.Transform {}
  const Be = new i.Point(),
    Re = new i.Matrix();
  let Oe;
  class ke extends r.Container {
    constructor(t) {
      super(),
    ...
    static from(t, e) {
      const i = new this(e);
      return Te.setupLive2DModel(i, t, e).then(() => i);
    }
    static fromSync(t, e) {
      const i = new this(e);
      return (
        Te.setupLive2DModel(i, t, e)
    ...
    set autoUpdate(t) {
      var e;
      Oe || (Oe = null == (e = window.PIXI) ? void 0 : e.Ticker),
        t
          ? this._destroyed ||
            (Oe
              ? (Oe.shared.add(this.onTickerUpdate, this),
                (this._autoUpdate = !0))
              : ee.warn(
                  this.tag,
                  "No Ticker registered, please call Live2DModel.registerTicker(Ticker)."
                ))
          : (null == Oe || Oe.shared.remove(this.onTickerUpdate, this),
            (this._autoUpdate = !1));
    }
    init(t) {
    ...
    focus(t, e, i = !1) {
      (Be.x = t), (Be.y = e), this.toModelPosition(Be, Be, !0);
      let s = (Be.x / this.internalModel.originalWidth) * 2 - 1,
        r = (Be.y / this.internalModel.originalHeight) * 2 - 1,
        a = Math.atan2(r, s);
      this.internalModel.focusController.focus(Math.cos(a), -Math.sin(a), i);
    }
    tap(t, e) {
      const i = this.hitTest(t, e);
      i.length && (ee.log(this.tag, "Hit", i), this.emit("hit", i));
    }
    hitTest(t, e) {
      return (
        (Be.x = t),
        (Be.y = e),
        this.toModelPosition(Be, Be),
        this.internalModel.hitTest(Be.x, Be.y)
      );
    }
    ...
    _render(t) {
      ...
      (this.internalModel.viewport = [i.x, i.y, i.width, i.height]),
        this.deltaTime &&
          ...
          (this.deltaTime = 0));
      const s = Re.copyFrom(t.globalUniforms.uniforms.projectionMatrix).append(
        this.worldTransform
      );
  ...
  const Ue = class {
    static resolveURL(t, e) {
      var i;
      const s = null == (i = Ue.filesMap[t]) ? void 0 : i[e];
      if (void 0 === s)
    ...
    static createSettings(t) {
      return __async(this, null, function* () {
        ...
        const i = yield Ue.readText(e),
          s = JSON.parse(i);
        s.url = e.webkitRelativePath;
        const r = Te.findRuntime(s);
      ...
      __async(this, null, function* () {
        if (Array.isArray(t.source) && t.source[0] instanceof File) {
          ...
          if (i) {
            if (!i._objectURL)
              throw new Error(
                '"_objectURL" must be specified in ModelSettings'
              );
          } else i = yield Ue.createSettings(e);
          i.validateFiles(e.map((t) => encodeURI(t.webkitRelativePath))),
            yield Ue.upload(e, i),
            (i.resolveURL = function (t) {
              return Ue.resolveURL(this._objectURL, t);
            }),
            (t.source = i),
            t.live2dModel.once("modelLoaded", (t) => {
              t.once("destroy", function () {
                const t = this.settings._objectURL;
                if ((URL.revokeObjectURL(t), Ue.filesMap[t]))
                  for (const e of Object.values(Ue.filesMap[t]))
                    URL.revokeObjectURL(e);
                delete Ue.filesMap[t];
              });
            });
        }
        return e();
      })),
    Te.live2DModelMiddlewares.unshift(Ne.factory);
  const Ve = class {
    static unzip(t, i) {
      return __async(this, null, function* () {
        const s = yield Ve.getFilePaths(t),
          r = [];
        for (const t of i.getDefinedFiles()) {
          const a = decodeURI(e.url.resolve(i.url, t));
          s.includes(a) && r.push(a);
        }
        const a = yield Ve.getFiles(t, r);
  ...
  if (
    ...
    (je.factory = (t, e) =>
      __async(this, null, function* () {
        ...
        if (
          ("string" == typeof i &&
          (i.endsWith(".zip") || i.startsWith(Ve.ZIP_PROTOCOL))
            ? ((s = i.startsWith(Ve.ZIP_PROTOCOL)
                ? i.slice(Ve.ZIP_PROTOCOL.length)
                : i),
              (r = yield ve.load({
                url: s,
                type: "blob",
          ...
          const e = yield Ve.zipReader(r, s);
          a || (a = yield Ve.createSettings(e)),
            (a._objectURL = Ve.ZIP_PROTOCOL + Ve.uid + "/" + a.url);
          const i = yield Ve.unzip(e, a);
          (i.settings = a),
            (t.source = i),
            s.startsWith("blob:") &&
              t.live2dModel.once("modelLoaded", (t) => {
    ...
    Te.live2DModelMiddlewares.unshift(je.factory),
  ...
  class Xe extends le {
    constructor(t) {
      if ((super(t), !Xe.isValidJSON(t))) throw new TypeError("Invalid JSON.");
      Object.assign(this, new Ht(t));
    }
  ...
  class ze extends me {
    ...
    init(t) {
      super.init(t),
        this.settings.expressions &&
          (this.expressionManager = new Ge(this.settings, t)),
    ...
    createMotion(e, i, s) {
      const r = et.create(e),
        ...
        o =
          (i === this.groups.idle
            ? t.config.idleMotionFadingDuration
            : t.config.motionFadingDuration) / 1e3;
      return (
        void 0 === a.getMotionFadeInTime() &&
          r.setFadeInTime(s.FadeInTime > 0 ? s.FadeInTime : o),
        void 0 === a.getMotionFadeOutTime() &&
          r.setFadeOutTime(s.FadeOutTime > 0 ? s.FadeOutTime : o),
  ...
  class He extends pe {
    constructor(t, e, s) {
      super(),
        (this.lipSync = !0),
        (this.breath = a.create()),
        (this.renderer = new Wt()),
        (this.idParamAngleX = Yt),
        (this.idParamAngleY = qt),
        (this.idParamAngleZ = $t),
        (this.idParamEyeBallX = Zt),
        (this.idParamEyeBallY = Jt),
        (this.idParamBodyAngleX = Qt),
        (this.idParamBreath = Kt),
        (this.pixelsPerUnit = 1),
        (this.centeringTransform = new i.Matrix()),
        (this.coreModel = t),
        (this.settings = e),
        (this.motionManager = new ze(e, s)),
        this.init();
    }
    init() {
      var t;
      super.init(),
        (null == (t = this.settings.getEyeBlinkParameters())
          ? void 0
          : t.length) > 0 && (this.eyeBlink = l.create(this.settings)),
        this.breath.setParameters([
          new o(this.idParamAngleX, 0, 15, 6.5345, 0.5),
          new o(this.idParamAngleY, 0, 8, 3.5345, 0.5),
          new o(this.idParamAngleZ, 0, 10, 5.5345, 0.5),
          new o(this.idParamBodyAngleX, 0, 4, 15.5345, 0.5),
          new o(this.idParamBreath, 0, 0.5, 3.2345, 0.5),
        ]),
    ...
    setupLayout() {
      super.setupLayout(),
        (this.pixelsPerUnit =
          this.coreModel.getModel().canvasinfo.PixelsPerUnit),
    ...
    getDrawableVertices(t) {
      if (
        "string" == typeof t &&
        -1 === (t = this.coreModel.getDrawableIndex(t))
      )
    ...
    updateFocus() {
      this.coreModel.addParameterValueById(
        ...
        this.focusController.x
      ),
        this.coreModel.addParameterValueById(
          this.idParamEyeBallY,
          this.focusController.y
        ),
        this.coreModel.addParameterValueById(
          this.idParamAngleX,
          ...
          (Ye = new Promise((t, e) => {
            !(function i() {
              try {
                ...
                ee.log("Cubism4", "Startup failed, retrying 10ms later..."),
                  setTimeout(i, 10);
              }
            })();
          })),
  ...
  function Ze(t) {
    (t = Object.assign(
      { logFunction: console.log, loggingLevel: S.LogLevel_Verbose },
      t
    )),
      C.startUp(t),
      C.initialize();
  ...
  Te.registerRuntime({
    ...
    createInternalModel(t, e, i) {
      const s = new He(t, e, i),
        r = t;
      return (
        r.__moc && ((s.__moc = r.__moc), delete r.__moc, s.once("destroy", Je)),
        s
      );
    },
    createPhysics: (t, e) => gt.create(e),
    createPose: (t, e) => u.create(e),
  }),
    (t.ACubismMotion = R),
    (t.BreathParameterData = o),
    (t.CSM_ASSERT = b),
    (t.Constant = P),
    (t.Cubism4ExpressionManager = Ge),
    (t.Cubism4InternalModel = He),
    (t.Cubism4ModelSettings = Xe),
    (t.Cubism4MotionManager = ze),
    (t.CubismBlendMode = f),
    (t.CubismBreath = a),
    (t.CubismClippingContext = Rt),
    (t.CubismClippingManager_WebGL = At),
    (t.CubismDebug = E),
    ...
    (t.CubismLogVerbose = function (t, ...e) {
      E.print(S.LogLevel_Verbose, "[CSM][V]" + t + "\n", e);
    }),
    ...
    (t.CubismMoc = F),
    (t.CubismModel = D),
    (t.CubismModelSettingsJson = Ht),
    (t.CubismModelUserData = B),
    (t.CubismModelUserDataJson = A),
    (t.CubismMotion = et),
    (t.CubismMotionCurve = X),
    (t.CubismMotionCurveTarget = N),
    (t.CubismMotionData = W),
    (t.CubismMotionEvent = z),
    (t.CubismMotionJson = H),
    (t.CubismMotionManager = class extends st {
      constructor() {
    ...
    (t.CubismMotionPoint = j),
    (t.CubismMotionQueueEntry = it),
    (t.CubismMotionQueueManager = st),
    (t.CubismMotionSegment = G),
    (t.CubismMotionSegmentType = V),
    (t.CubismPhysics = gt),
    (t.CubismPhysicsInput = ht),
    (t.CubismPhysicsJson = ct),
    (t.CubismPhysicsOutput = ut),
    (t.CubismPhysicsParticle = nt),
    (t.CubismPhysicsRig = dt),
    (t.CubismPhysicsSource = ot),
    (t.CubismPhysicsSubRig = lt),
    (t.CubismPhysicsTargetType = at),
    (t.CubismPose = u),
    (t.CubismRenderTextureResource = Bt),
    (t.CubismRenderer = _),
    (t.CubismRenderer_WebGL = Wt),
    (t.CubismShader_WebGL = Ot),
    (t.CubismTextureColor = y),
    (t.CubismVector2 = c),
    (t.EvaluationOptionFlag = Y),
    (t.ExpressionBlendType = U),
    (t.ExpressionManager = oe),
    (t.EyeState = h),
    (t.FileLoader = Ne),
    (t.FocusController = ne),
    (t.HitAreaBody = "Body"),
    (t.HitAreaHead = "Head"),
    (t.HitAreaPrefix = "HitArea"),
    (t.InteractionMixin = Ee),
    (t.InternalModel = pe),
    (t.InvalidMotionQueueEntryHandleValue = rt),
    (t.LOGICAL_HEIGHT = 2),
    (t.LOGICAL_WIDTH = 2),
    (t.Live2DFactory = Te),
    (t.Live2DLoader = ve),
    (t.Live2DModel = ke),
    (t.Live2DTransform = Ae),
    (t.LogLevel = S),
    (t.ModelSettings = le),
    (t.MotionManager = me),
    (t.MotionPreloadStrategy = ce),
    (t.MotionPriority = he),
    (t.MotionState = ue),
    (t.Options = pt),
    (t.ParamAngleX = Yt),
    ...
    (t.copyArray = function (t, e, i, s, r) {
      const a = e[s];
      Array.isArray(a) &&
        (i[r] = a.filter((e) => null !== e && typeof e === t));
    }),
    ...
    (t.cubism4Ready = $e),
    (t.folderName = re),
    (t.fragmentShaderSrcMaskInvertedPremultipliedAlpha = zt),
    (t.fragmentShaderSrcMaskPremultipliedAlpha = Xt),
    (t.fragmentShaderSrcPremultipliedAlpha = Gt),
    (t.fragmentShaderSrcsetupMask = Nt),
    (t.logger = ee),
    (t.rand = function (t, e) {
    ...
    (t.remove = ae),
    (t.startUpCubism4 = Ze),
    (t.vertexShaderSrc = Vt),
    (t.vertexShaderSrcMasked = jt),
    (t.vertexShaderSrcSetupMask = Ut),
